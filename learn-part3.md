...
![Similarities between placenta, tumor, and transplant models](/assets/images/placeholder.png)
...
Pregnancy is the only known instance in mammalian biology where the immune system naturally tolerates a genetically foreign entity. The foreign antigen is defined: paternal MHC molecules, expressed on fetal and placental cells, are distinct from the mother's own and recognizable to her immune system. The maternal immune system sees these antigens, yet it actively decides not to attack them. The system is physiological — this happens in every healthy pregnancy, in every mammal, without drugs or clinical intervention. It unfolds on a precise timeline (nine months in humans, 18–21 days in mice), giving researchers a roadmap of tolerance induction, maintenance, and resolution that other systems do not provide.
