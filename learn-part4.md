...
Recurrent miscarriage, defined as three or more consecutive pregnancy losses, affects roughly 1–2% of couples trying to conceive, and in at least half of cases no chromosomal or anatomical explanation is found. The leading immunological hypothesis centers on **Treg failure**. In healthy pregnancies, Tregs accumulate in the decidua specifically in response to paternal antigens, suppressing the immune response against the fetus. In some women with recurrent miscarriage, studies have found significantly reduced Treg numbers and activity at the implantation site, along with elevated pro-inflammatory cytokines that would normally be suppressed. There is also evidence that uterine NK cell populations are present in unusually high numbers or in a less tolerogenic state.
...
Preeclampsia (PE) is a multisystem hypertensive disorder of pregnancy that affects approximately 5–8% of pregnancies worldwide. Clinically, PE is defined by new-onset hypertension after 20 weeks of gestation, accompanied by high levels of protein in the urine or evidence of end-organ dysfunction, including renal insufficiency, hepatic injury, thrombocytopenia, pulmonary edema, or neurologic symptoms. The disease exists along a spectrum of severity, and can progress to **eclampsia** (life-threatening seizures or coma) and **HELLP syndrome** (hemolysis, elevated liver enzymes, and low platelets). PE accounts for up to 26% of maternal deaths in low-income countries and 16% in high-income countries.
